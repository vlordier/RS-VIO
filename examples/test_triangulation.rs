...
fn main() {
    ...
    println!("  Left observation: [{:.6}, {:.6}, 1.0]", point_left.x, point_left.y);
    println!("  Right observation: [{:.6}, {:.6}, 1.0]", point_right.x, point_right.y);
    ...
    let point_left = Vector3::new(point_world.x / point_world.z, point_world.y / point_world.z, 1.0);
    let point_right_cam = point_world - Vector3::new(0.1, 0.0, 0.0);
    let point_right = Vector3::new(point_right_cam.x / point_right_cam.z, point_right_cam.y / point_right_cam.z, 1.0);
