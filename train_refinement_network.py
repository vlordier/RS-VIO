...
def train_refinement_network():
    ...
    print("="*70)
    print("Task: Learn position CORRECTIONS (not absolute positions)")
    print("Input: Visual features + IMU + Flow + VIO estimate")
    print("Output: Position delta (delta_x, delta_y, delta_z)")
    print("="*70 + "\n")
...
def export_to_onnx(model, output_path):
    ...
    print("  Input names: left_image (1,1,480,640), flow (1,96), imu (1,15), vio_estimate (1,3)")
    print("  Output names: correction (1,3)")
    print("="*70 + "\n")
