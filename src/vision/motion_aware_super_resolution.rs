...
impl MotionAwareSuperResolver {
    ...
    pub fn filtered_motion(&self) -> Option<MotionState> {
        ...
        let avg_accel = self
            ...
            .fold([0.0; 3], |acc, a| {
                [acc[0] + a[0] / n, acc[1] + a[1] / n, acc[2] + a[2] / n]
            });
        ...
        let avg_gyro = self
            ...
            .fold([0.0; 3], |acc, g| {
                [acc[0] + g[0] / n, acc[1] + g[1] / n, acc[2] + g[2] / n]
            });
        ...
        Some(MotionState {
            ...
            velocity: avg_vel,
            accel_magnitude: (avg_accel[0].powi(2) + avg_accel[1].powi(2) + avg_accel[2].powi(2))
                .sqrt(),
            velocity_magnitude: (avg_vel[0].powi(2) + avg_vel[1].powi(2) + avg_vel[2].powi(2))
                .sqrt(),
            rotation_magnitude: (avg_gyro[0].powi(2) + avg_gyro[1].powi(2) + avg_gyro[2].powi(2))
                .sqrt(),
    ...
    pub fn refine_with_motion(
        ...
        let combined_confidence =
            (distance_confidence * speed_confidence * patch_confidence).clamp(0.2, 1.0);
