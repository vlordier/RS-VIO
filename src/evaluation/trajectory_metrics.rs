...
pub fn compute_rpe(
    ...
    Ok(TrajectoryMetrics {
        ...
        ate_max: translation_errors
            .iter()
            .copied()
            .fold(f64::NEG_INFINITY, f64::max),
        ate_min: translation_errors
            .iter()
            .copied()
