...
def plot_tracking_comparison(csv_file):
    ...
    print(f"Saved: ./plot_output/tracking_comparison.png")
    plt.show()
...
def plot_disparity_comparison(csv_file):
    ...
    print(f"Saved: ./plot_output/disparity_comparison.png")
    plt.show()
...
def plot_rolling_shutter_comparison(csv_file):
    ...
    print(f"Saved: ./plot_output/rolling_shutter_comparison.png")
    plt.show()
