...
def plot_tracking_comparison(csv_file):
    ...
    plt.tight_layout()
    plt.savefig('./tum_vi_results/tracking_comparison.png', dpi=300, bbox_inches='tight')
    print(f"Saved: ./tum_vi_results/tracking_comparison.png")
    plt.show()
...
def plot_disparity_comparison(csv_file):
    ...
    plt.tight_layout()
    plt.savefig('./tum_vi_results/disparity_comparison.png', dpi=300, bbox_inches='tight')
    print(f"Saved: ./tum_vi_results/disparity_comparison.png")
    plt.show()
...
def plot_rolling_shutter_comparison(csv_file):
    ...
    plt.tight_layout()
    plt.savefig('./tum_vi_results/rolling_shutter_comparison.png', dpi=300, bbox_inches='tight')
    print(f"Saved: ./tum_vi_results/rolling_shutter_comparison.png")
    plt.show()
