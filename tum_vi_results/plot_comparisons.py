...
def plot_tracking_comparison(csv_file):
    ...
    print("Saved: ./tum_vi_results/tracking_comparison.png")
    plt.show()
...
def plot_disparity_comparison(csv_file):
    ...
    print("Saved: ./tum_vi_results/disparity_comparison.png")
    plt.show()
...
def plot_rolling_shutter_comparison(csv_file):
    ...
    print("Saved: ./tum_vi_results/rolling_shutter_comparison.png")
    plt.show()
